...
export default function Navbar() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 isolate transform-gpu border-b border-white/10 bg-[#16445a]/50 px-4 py-4 md:px-6 shadow-[0_4px_20px_rgba(0,0,0,0.14)] backdrop-blur-sm">
